...
// карта
	...
	$('.more').click(function () {
		...
		var item = $('.projects-container-item')
	...
	$('.more-n').click(function () {
		...
		var item = $('.projects-set-sfe-check')

		if(item.hasClass('hide')) {
			item.removeClass('hide')
			$('.more-n').addClass('hide')
		}
	...
	$('.more-down').click(function () {
		...
		var item = $('.down-left-item')

		if(item.hasClass('hide')) {
			item.removeClass('hide')
			$('.more-down').addClass('hide')
		}
	...
	$('.theme').click(function () {
		...
		if(body.hasClass('dark')) {
			...
			$('.logo-m').addClass('hide')
			$('.logo-s').removeClass('hide')
			$('.close-sun').removeClass('hide')
			$('.close-moon').addClass('hide')
			console.log('sun')
		}
		else {
			body.addClass('dark')
			...
			moon.addClass('hide')
			$('.logo-m').removeClass('hide')
			$('.logo-s').addClass('hide')
			$('.close-sun').addClass('hide')
			$('.close-moon').removeClass('hide')
			console.log('moon')
		}
	})


	// Типовая страница слайдер
	...
	// Типовая страница проект слайдер
	...
	$(window).scroll(function() {
		if($(window).scrollTop() > 600) {
			...
			$('.del').removeClass('count2')
		}
	});


	$('.circle1').addClass('anim')
